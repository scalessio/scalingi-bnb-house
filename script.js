  ...
  switchLanguage(lang) {
    const translations = {
      it: {
        ...
        'review-1': '"Siamo stati assistiti con gentilezza e cordialità [...] casa in buona posizione, silenziosa, riservata e comoda. Ci è dispiaciuto dover andare via!"',
        'review-2': '"Ottima posizione. Antonio è stato molto reattivo. Molto vicino alla spiaggia, e il centro storico è imperdibile!"',
        'review-3': '"Alloggio dotato di tutto il necessario e molto accogliente [...] posizione tranquilla ma comodissima per raggiungere a piedi il mare e il centro storico. Host gentili e disponibili, torneremo sicuramente."',
        'host-card-badge': 'Superhost',
        'host-card-title': 'Antonio, il tuo host',
        'host-card-text': 'Superhost e host da 11 anni sulle piattaforme: Antonio accoglie ogni ospite con attenzione, consigli locali e disponibilità.',
        'host-card-author': 'Esperienza, cura, ospitalità',
        'host-card-meta': '11 anni di ospitalità',
        'review-4': '"Soggiorno fantastico. Antonio è super reattivo e disponibile [...] parcheggio facile e tutto il necessario per preparare i pasti. Ci torneremo sicuramente."',
        'review-5': '"Antonio è stato il miglior host Airbnb che avremmo mai potuto desiderare [...] appartamento pulito, confortevole e in un\'ottima posizione. Il soggiorno è stato perfetto."',
        'review-6': '"Weekend in famiglia, con la nostra piccola di un anno e mezzo. Casa comodissima a due passi dal mare e da tutti i servizi, pulitissima e in una zona tranquilla [...]"',
        'review-7': '"Posizione vicino al mare, pulizia ottimale e tutto il necessario per la colazione. Host disponibilissimo e ci ha permesso di tenere l\'auto dopo il check-out."',
        ...
        'booking-availability-loading': 'Stiamo caricando la disponibilità...',
        'booking-availability-select-apartment': 'Seleziona un appartamento per visualizzare le date disponibili. Il soggiorno minimo è di due notti.',
        'booking-availability-ready': 'Calendario aggiornato. Le date grigie non sono disponibili. Il soggiorno minimo è di due notti.',
        'booking-availability-error': 'Non riusciamo a caricare la disponibilità. Riprova tra poco.',
      ...
      en: {
        ...
        'review-1': '"We were assisted with kindness and warmth [...] the apartment is well located, quiet, private and comfortable. We were sorry to leave!"',
        'review-2': '"Great location. Antonio was very responsive. Very close to the beach, and the historic centre is not to be missed!"',
        'review-3': '"The apartment had everything we needed and was very welcoming [...] a quiet location, yet very convenient for walking to the sea and historic centre. Kind, helpful hosts and we will definitely return."',
        'host-card-badge': 'Superhost',
        'host-card-title': 'Antonio, your host',
        'host-card-text': 'A Superhost with 11 years of hosting experience, Antonio welcomes every guest with care, local advice and availability.',
        'host-card-author': 'Experience, care, hospitality',
        'host-card-meta': '11 years of hosting',
        'review-4': '"Fantastic stay. Antonio is super responsive and helpful [...] easy parking and everything needed to prepare meals. We will definitely return."',
        'review-5': '"Antonio was the best Airbnb host we could have wished for [...] the apartment was clean, comfortable and in a great location. The stay was perfect."',
        'review-6': '"A family weekend with our one-and-a-half-year-old. The apartment is steps from the sea and all services, spotless and in a quiet area [...]"',
        'review-7': '"Location close to the sea, excellent cleanliness and everything needed for breakfast. A very helpful host who let us keep the car after check-out."',
        ...
        'booking-availability-loading': 'Loading availability...',
        'booking-availability-select-apartment': 'Select an apartment to view available dates. The minimum stay is two nights.',
        'booking-availability-ready': 'Calendar updated. Grey dates are unavailable. The minimum stay is two nights.',
        'booking-availability-error': 'We could not load availability. Please try again shortly.',
