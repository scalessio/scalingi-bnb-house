  ...
  switchLanguage(lang) {
    const translations = {
      it: {
        ...
        'booking-availability-notice-text': 'Le richieste di disponibilità sono aperte dal 1 settembre.',
      ...
      en: {
        ...
        'booking-availability-notice-text': 'Availability requests are open from 1 September.',
