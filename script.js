  ...
  switchLanguage(lang) {
    const translations = {
      ...
      en: {
        ...
        'booking-availability-select-apartment': 'Select an apartment to view available dates.',
        'booking-availability-ready': 'Calendar updated. Grey dates are unavailable.',
